...
class Submit extends Component {
  ...
  stateSetter = () => {
    ...
    if (profile) {
      this.setState({ d_name: profile[profile.length - 1].donor_name,
      ...
      <div className="submitpage">
        ...
        <div className="header-box">
          ...
          <p id="info-text">
            ...
            <br />
            Once you click submit: this.state, you will have to request a change through
            email.
          </p>
        </div>
        ...
        <div className="submit-button">
            ...
            <button onClick={() => {this.handleSave(); this.setState({ show: true })}}>
            Submit
          </button>
          <SweetAlert
